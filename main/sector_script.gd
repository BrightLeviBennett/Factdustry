...
func _draw() -> void:
	...
	for text_id in _text_overlays:
		...
		# More transparent fill so the scripted text overlay reads as
		# a glass card over the world instead of a solid plate.
		draw_rect(bg_rect, Color(0.05, 0.05, 0.08, 0.45), true)
		draw_rect(bg_rect, Color(0.4, 0.4, 0.5, 0.35), false, 1.0)
