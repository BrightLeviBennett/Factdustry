...
func _register_power() -> void:
	...
	_add(&"beam_node",            "Beam Node",            [&"rotational_generator"],    [], {&"mat_copper": 150, &"mat_silicon": 60, &"mat_steel": 30}, Vector2(-0, 3))
	_add(&"beam_tower",           "Beam Tower",           [&"beam_node"],               [], {&"mat_copper": 250, &"mat_silicon": 100, &"mat_steel": 70}, Vector2(0, 4))
...
func _register_fluid_transport() -> void:
	_add(&"fluid_conduit",              "Fluid Conduit",              [&"core_shard"],          [&"-L-ferrum_ridge"], {&"mat_copper": 25, &"mat_graphite": 10}, Vector2(18, 1))
...
func _register_mining() -> void:
	...
	_add(&"wall_crusher",          "Wall Crusher",          [&"mechanical_drill"],      [&"mat_graphite"], {&"mat_copper": 80, &"mat_steel": 25}, Vector2(23, -2))
	...
	_add(&"wall_grinder",          "Wall Grinder",          [&"wall_crusher"],          [], {&"mat_copper": 160, &"mat_steel": 50, &"mat_graphite": 30}, Vector2(23, -3))
...
func _register_materials() -> void:
	...
	_add(&"mat_silicon",        "Silicon",         [&"mat_sand"],                        [], {}, Vector2(25, 3), true)
	_add(&"mat_carbon_dioxide", "Carbon Dioxide",  [&"mat_graphite"],                    [], {}, Vector2(27, 3), true)
	_add(&"mat_steel",          "Steel",           [&"mat_iron", &"mat_carbon_dioxide"], [], {}, Vector2(29, 3), true)
	...
	_add(&"mat_petroleum",      "Petroleum",       [&"mat_carbon_dioxide"],              [], {}, Vector2(27, 4), true)
	_add(&"mat_acetylene",      "Acetylene",       [&"mat_carbon_dioxide"],              [], {}, Vector2(26, 4), true)
...
func _register_production() -> void:
	...
	_add(&"circuit_printer",             "Circuit Printer",             [&"silicon_mixer"],                    [], {&"mat_copper": 160, &"mat_silicon": 60, &"mat_graphite": 25}, Vector2(-5, 3))
	_add(&"water_filter",                "Water Filter",                [&"silicon_mixer"],                    [], {&"mat_copper": 120, &"mat_silicon": 40, &"mat_graphite": 20}, Vector2(-4, 3))
	_add(&"petroleum_refinery",          "Petroleum Refinery",          [&"steel_furnace"],                    [], {&"mat_copper": 250, &"mat_steel": 110, &"mat_silicon": 60}, Vector2(-7, 4))
	_add(&"air_filter",                  "Air Filter",                  [&"graphite_electrolyzer"],            [], {&"mat_copper": 200, &"mat_silicon": 70, &"mat_graphite": 40, &"mat_steel": 25}, Vector2(-6, 4))

func _register_turrets() -> void:
	# Single Barrel branch
	_add(&"single_barrel",   "Single Barrel",   [&"core_shard"],                       [], {&"mat_copper": 40}, Vector2(-11, 1))
	_add(&"diffuse",         "Diffuse",         [&"single_barrel"],                    [&"Not unlockable in campaign"], {&"mat_copper": 80, &"mat_silicon": 25}, Vector2(-11, 2))
	_add(&"double_barrel",   "Double Barrel",   [&"single_barrel"],                    [&"Not unlockable in campaign"], {&"mat_copper": 90, &"mat_steel": 30}, Vector2(-10, 2))
...
func _register_units() -> void:
	...
	_add(&"turtle",                   "Turtle",                   [&"armadillo"],                 [], {&"mat_copper": 600, &"mat_steel": 280, &"mat_bronze": 30}, Vector2(-28, 6))
	# Crawler branch
	...
	_add(&"lizard",                   "Lizard",                   [&"geckeo"],                    [], {&"mat_copper": 400, &"mat_silicon": 130, &"mat_steel": 80}, Vector2(-29, 4))
	_add(&"iguana",                   "Iguana",                   [&"lizard"],                    [], {&"mat_copper": 600, &"mat_silicon": 200, &"mat_steel": 150}, Vector2(-29, 5))
	_add(&"chameleon",                "Chameleon",                [&"iguana"],                    [], {&"mat_copper": 800, &"mat_silicon": 300, &"mat_steel": 230}, Vector2(-29, 6))
	_add(&"moniter",                  "Moniter",                  [&"chameleon"],                 [], {&"mat_copper": 1200, &"mat_silicon": 450, &"mat_steel": 370, &"mat_aluminum": 30}, Vector2(-29, 7))
	# Support Hover branch
	_add(&"support_hover_fabricator", "Support Hover Fabricator", [&"tank_fabricator"],           [&"Not unlockable in campaign"], {&"mat_copper": 110, &"mat_graphite": 35}, Vector2(-27, 2))
	_add(&"destroy_unit",             "Destroy",                  [&"support_hover_fabricator"],  [], {&"mat_copper": 200, &"mat_graphite": 60, &"mat_steel": 30}, Vector2(-27, 3))
	_add(&"rebuild",                  "Rebuild",                  [&"destroy_unit"],              [], {&"mat_copper": 300, &"mat_graphite": 100, &"mat_steel": 50}, Vector2(-27, 4))
	_add(&"assist",                   "Assist",                   [&"rebuild"],                   [], {&"mat_copper": 450, &"mat_graphite": 150, &"mat_steel": 105}, Vector2(-27, 5))
	...
	_add(&"moth",                     "Moth",                     [&"fly"],                       [], {&"mat_copper": 360, &"mat_graphite": 120, &"mat_steel": 50}, Vector2(-25, 4))
	_add(&"kestrel",                  "Kestrel",                  [&"moth"],                      [], {&"mat_copper": 520, &"mat_graphite": 180, &"mat_steel": 110}, Vector2(-25, 5))
	_add(&"hawk",                     "Hawk",                     [&"kestrel"],                   [], {&"mat_copper": 750, &"mat_graphite": 260, &"mat_steel": 190}, Vector2(-25, 6))
	_add(&"eagle",                    "Eagle",                    [&"hawk"],                      [], {&"mat_copper": 1100, &"mat_graphite": 400, &"mat_steel": 300}, Vector2(-25, 7))
	# Unit Upgrader branch
	_add(&"unit_refabricator",        "Unit Refabricator",        [&"tank_fabricator"],           [&"Not unlockable in campaign"], {&"mat_copper": 150, &"mat_silicon": 50}, Vector2(-24, 2))
	_add(&"unit_upgrader",            "Unit Upgrader",            [&"unit_refabricator"],         [], {&"mat_copper": 280, &"mat_silicon": 90, &"mat_steel": 35}, Vector2(-24, 3))
